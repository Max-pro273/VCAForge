...
class Engine(Protocol):
    ...
    def write_input(
        self, dest_dir: Any, cell_template: Any,
        species_mix: list[tuple[str, float]], x: float,
    ) -> None: ...

    def write_params(
        self, dest: Any, task: str, xc: str, cutoff: int,
        spin: bool, nextra: int, smearing: float,
    ) -> None: ...
