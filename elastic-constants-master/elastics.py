...
# scipy_compat_shim
# scipy>=1.13 removed numpy re-exports (array, sqrt, row_stack, etc.)
...
# scipy_compat_shim - Python 3.12+ / scipy>=1.13 compatibility
import scipy as S
...
def main(input_options, libmode=False):
    ...
    for patt in range(numStrainPatterns//numsteps):
        ...
        def __fit(index1, index2):
            ...
            (vmajor,vminor,vmicro) = re.split(r'\.',S.__version__)
